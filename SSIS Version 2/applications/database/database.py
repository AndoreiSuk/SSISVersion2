...
class Database:
    ...
    def get_all(self, keyword=None, filter_criteria=None, sort_by=None, sort_order='ASC'):
        ...
        if self.table_name == 'programs' and keyword:
            ...
            # This allows searching by college name in addition to program fields.
            ...
            # Keyword conditions for programs table (programID, programNAME, programs.collegeCODE, colleges.collegeNAME)
            keyword_conditions = []
            # Search in programs table columns
            for col_sql_name in self.columns_sql_names: # self.columns_sql_names are for the 'programs' table
